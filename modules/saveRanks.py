...
from modules.runTimeSecrets import HOST, DB, USER, PASS, HOST3, DB3, USER3, PASS3
    ...
    try:
        ...
        if conn.is_connected():
            ...
            this.execute(f"""
                WITH RankedData AS (
                    SELECT
                        ...
                        TempVendorPricing.vendorprice_instant_discount,
                        TempVendorPricing.vendorprice_shipping_zip_code_id,
            ...
            if result2:
                for row in result2:
                    ...
                    pricing_data.append({
                        ...
                        "vendorprice_instant_discount" : row[22],
                        "vendorprice_shipping_zip_code_id" : row[23]
                    })
                ...
                if result01:
                    ...
                    if includeSis:
                        pricing_data.append({
                            ...
                            "vendorprice_instant_discount" : result01[22],
                            "vendorprice_shipping_zip_code_id" : result01[23]
                        })
                else:
            ...
            if result0:
                ...
                last_7th_day_date_date = datetime.strptime(last_7th_day_date, '%Y-%m-%d').date()
                # print(last_7th_day_date_date, result0[11])
                if last_7th_day_date_date > result0[11]:
                    ...
                    this.execute(f"""
                        SELECT
                            ...
                            ErpData.update_sales,
                            CouponCode.coupon_percentage,
                            ShippingType.shipping_value
                        FROM ErpData
                        LEFT JOIN CouponCode ON CouponCode.coupon_id = ErpData.promotional_id
                        LEFT JOIN ShippingType ON ShippingType.shipping_code = ErpData.shipping_type
                        WHERE
                            ShippingType.vendor_id = {vendor_id} AND ErpData.vendor_product_id = {vendor_product_id}
                            AND ErpData.website_price IS NOT NULL
                        LIMIT 1;
                    """)
                    erp = this.fetchone()
                    if erp:
                        ...
                        # shipping amount
                        shipping_amount = erp[3] if erp[3] is not None else 0.00
                ...
                if include:
                    pricing_data.append({
                        ...
                        "vendorprice_instant_discount" : result0[22],
                        "vendorprice_shipping_zip_code_id" : result0[23]
                    })
                    # print(pricing_data)
                else:
            ...
            if len(pricing_data) > 0:   # and foundOthers
                ...
                #     VendorProductId = data.get('vendor_product_id')
                ...
                #             """, (rank_for_vndor, VendorProductId))
                #             conn.commit()
                #             logger.debug(f"Updated rank to {rank_for_vndor} for vendor_product_id {VendorProductId}")
                #         except Exception as e:
                #             # logger.debug(f"Error updating AF Supply rank: {e}")
                #             logger.debug(f"Error updating rank for vendor_product_id {VendorProductId}: {e}")
                # print(lowestFiveVendors)
                # exit()
                for data in lowestFiveVendors:
                    if rank == 1:
                        try:
                            ...
                            rankedVendors['first_vendor_instant_discount'] = data['vendorprice_instant_discount']
                            rankedVendors['first_vendor_shipping_zip_code_id'] = data['vendorprice_shipping_zip_code_id']
                        ...
                        try:
                            ...
                            rankedVendors['second_vendor_instant_discount'] = data['vendorprice_instant_discount']
                            rankedVendors['second_vendor_shipping_zip_code_id'] = data['vendorprice_shipping_zip_code_id']
                        ...
                        try:
                            ...
                            rankedVendors['third_vendor_instant_discount'] = data['vendorprice_instant_discount']
                            rankedVendors['third_vendor_shipping_zip_code_id'] = data['vendorprice_shipping_zip_code_id']
                        ...
                        try:
                            ...
                            rankedVendors['fourth_vendor_instant_discount'] = data['vendorprice_instant_discount']
                            rankedVendors['fourth_vendor_shipping_zip_code_id'] = data['vendorprice_shipping_zip_code_id']
                        ...
                        try:
                            ...
                            rankedVendors['fifth_vendor_instant_discount'] = data['vendorprice_instant_discount']
                            rankedVendors['fifth_vendor_shipping_zip_code_id'] = data['vendorprice_shipping_zip_code_id']
                ...
                this.execute("""
                    ...
                    SET
                       first_vendor_product_id = NULL, first_vendor_name = NULL, first_vendor_price = NULL, first_vendor_final_price = NULL, first_vendor_shipping = NULL,
                        ...
                        first_vendor_in_cart_price = NULL, first_vendor_product_page_price = NULL,first_vendor_instant_discount = NULL, first_vendor_shipping_zip_code_id = NULL,
                        ...
                        second_vendor_in_cart_price = NULL, second_vendor_product_page_price = NULL,second_vendor_instant_discount = NULL, second_vendor_shipping_zip_code_id = NULL,
                        ...
                        third_vendor_in_cart_price = NULL, third_vendor_product_page_price = NULL, third_vendor_instant_discount = NULL, third_vendor_shipping_zip_code_id = NULL,
                        ...
                        fourth_vendor_in_cart_price = NULL, fourth_vendor_product_page_price = NULL, fourth_vendor_instant_discount = NULL, fourth_vendor_shipping_zip_code_id = NULL,
                        ...
                        fifth_vendor_in_cart_price = NULL, fifth_vendor_product_page_price = NULL, fifth_vendor_instant_discount = NULL, fifth_vendor_shipping_zip_code_id = NULL,
                ...
                this.execute("""
                    SELECT
                        ...
                        vendorprice_isbackorder, is_active, vendorprice_offers, vendorprice_delivery_date, delivery_text, vendorprice_extra_discount,vendorprice_instant_discount, vendorprice_shipping_zip_code_id, currency, rank, source, shipping_time,
                        ...
                        fifth_vendor_in_cart_price, fifth_vendor_product_page_price, fifth_vendor_instant_discount, fifth_vendor_shipping_zip_code_id,
                ...
                insert_query = f"""
                    INSERT INTO {pricing_history_table} (
                       vendor_product_id,
                        ...
                        fourth_vendor_delivery_date, fourth_vendor_is_backorder, fourth_vendor_delivery_text_gmc, fourth_vendor_delivery_text_website, fourth_vendor_stock_text_website, fourth_vendor_price_date, fourth_vendor_stock, fourth_vendor_offer_heading, fourth_vendor_offer_text, fourth_vendor_in_cart_price, fourth_vendor_product_page_price, fourth_vendor_instant_discount , fourth_vendor_shipping_zip_code_id ,
                        fifth_vendor_product_id, fifth_vendor_name, fifth_vendor_price, fifth_vendor_final_price, fifth_vendor_shipping, fifth_vendor_extra_discount, fifth_vendor_product_url, fifth_vendor_source, 
                        fifth_vendor_delivery_date, fifth_vendor_is_backorder, fifth_vendor_delivery_text_gmc, fifth_vendor_delivery_text_website, fifth_vendor_stock_text_website, fifth_vendor_price_date, fifth_vendor_stock, fifth_vendor_offer_heading, fifth_vendor_offer_text,fifth_vendor_in_cart_price, fifth_vendor_product_page_price, fifth_vendor_instant_discount , fifth_vendor_shipping_zip_code_id ,
                        percentage, second_percentage, assumed_map_price,
                        rt, rp, rp_variation, rp_variation_sell_price, rp_coupon, achieved_gp, rp_criteria, is_rp_calculated,scraped_by_system, offer_heading,offer_text,In_cart_price,product_page_price
